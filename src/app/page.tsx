...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
      {/* ── Header ── */}
      <header className="flex items-center justify-between px-8 py-5 border-b border-slate-100 dark:border-white/5 animate-fade-in animate-entrance" style={{ animationDelay: '0ms' }}>
        <Logo />
      ...
      <main className="flex-1 flex">
        ...
        <div className="flex-1 flex flex-col justify-center px-16 lg:px-24 xl:px-32">
          <p className="text-[11px] tracking-[0.28em] text-slate-400 dark:text-slate-500 uppercase font-medium mb-10 animate-fade-up animate-entrance" style={{ animationDelay: '100ms' }}>
            V1.0 — Scheduling, Rewritten
          </p>

          <h1 className="text-5xl sm:text-6xl lg:text-[64px] font-bold text-slate-900 dark:text-white leading-[1.1] mb-6 animate-fade-up animate-entrance" style={{ animationDelay: '200ms' }}>
            Plan the day<br />you actually<br />have.
          </h1>

          <p className="text-slate-500 dark:text-slate-400 max-w-[360px] leading-relaxed text-[15px] mb-10 animate-fade-up animate-entrance" style={{ animationDelay: '330ms' }}>
          ...
          <div className="flex flex-wrap gap-4 mb-8 animate-fade-up animate-entrance" style={{ animationDelay: '450ms' }}>
            <Link
              href="/normal-user"
          ...
          <p className="text-slate-500 dark:text-slate-600 text-[13px] animate-fade-up animate-entrance" style={{ animationDelay: '530ms' }}>
            University admin?{' '}
        ...
        {/* Right column — clock */}
        <div className="flex-1 flex flex-col items-center justify-center animate-fade-right animate-entrance" style={{ animationDelay: '350ms' }}>
          <AnalogClock />
        </div>
      </main>

      {/* ── Footer feature row ── */}
      <footer className="px-8 py-5 border-t border-slate-100 dark:border-white/5 animate-fade-in animate-entrance" style={{ animationDelay: '700ms' }}>
