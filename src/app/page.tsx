    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <header style={fadeIn(0)}
          className="flex items-center justify-between px-8 py-5 border-b border-slate-100 dark:border-white/5"
        >
          <Logo />
        ...
        <main className="flex-1 flex">
          ...
          <div className="flex-1 flex flex-col justify-center px-16 lg:px-24 xl:px-32">
            ...
            <div style={up(280)} className="flex flex-wrap gap-4 mb-8">
              <Link
                href="/normal-user"
        ...
        <footer style={fadeIn(420)}
          className="px-8 py-5 border-t border-slate-100 dark:border-white/5"
        >
