    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex">
        ...
        <div className="flex-1 flex flex-col justify-center px-16 lg:px-24 xl:px-32">
          <p className="text-[11px] tracking-[0.28em] text-slate-500 uppercase font-medium mb-10">
            V1.0 — Scheduling, Rewritten
          </p>

          <h1 className="text-5xl sm:text-6xl lg:text-[64px] font-bold text-white leading-[1.1] mb-6">
            Plan the day<br />you actually<br />have.
          </h1>

          <p className="text-slate-400 max-w-[360px] leading-relaxed text-[15px] mb-10">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <Link
              href="/student"
              className="px-6 py-3 border border-white/25 text-white font-semibold rounded-lg text-sm hover:bg-white/5 transition-colors"
            >
              I&apos;m a student
            </Link>
          </div>
      ...
      {/* ── Footer feature row ── */}
      <footer className="px-8 py-5 border-t border-white/5">
        <div className="flex items-center justify-center gap-0 text-[11px] text-slate-600 tracking-wide">
